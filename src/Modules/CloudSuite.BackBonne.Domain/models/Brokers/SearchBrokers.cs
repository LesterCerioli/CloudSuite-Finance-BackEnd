...
{
    public class SearchBrokers : Entity, IAggregateRoot
    {
        public SearchBrokers(string bairro, CEP cep, CNPJ cnpj, string codigoCvm, string complemento, DateTime dataInicioSituacao, 

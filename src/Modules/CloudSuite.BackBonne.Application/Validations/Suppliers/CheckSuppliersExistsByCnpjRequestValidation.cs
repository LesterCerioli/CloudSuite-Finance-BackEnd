...
{
    public class CheckSuppliersExistsByCnpjRequestValidation : AbstractValidator<CheckSuppliersExistsByCnpjRequest>
    {
        public CheckSuppliersExistsByCnpjRequestValidation()
        {
            RuleFor(a => a.Cnpj)
